        ...
        <div className={scss.Hotels}>
          <div className={scss.hotel}>
            ...
            <div className={scss.hotel_images}>
              <Image src={hotel} alt="img" width={220} height={203} />
          ...
          <div className={scss.hotel}>
            <h1>Hotel Amir</h1>
            <div className={scss.hotel_images}>
              <Image src={hotel1} alt="img" width={220} height={203} />
              <div className={scss.addresses}>
                <h5>Location and contact details</h5>
                <div className={scss.address}>
                  <iframe
          ...
          <div className={scss.people}>
            ...
            <div className={scss.person}>
              ...
              <div className={scss.text}>
                ...
                <div className={scss.imagess}>
                  <Image src={images2} alt="img" width={210} height={197} />
                  <Image src={images3} alt="img" width={210} height={197} />
                  <Image src={images4} alt="img" width={210} height={197} />
                </div>
              </div>
            </div>
          </div>
